...
import { createScheduleRoute, inviteRoute, scheduleCrewRoute, submitAvailabilityRoute, userRoute, viewScheduleRoute } from '@/router/dynamicRoutes'
...
async function handleLogin () {    
    try {
        ...
        if (userRole === 'admin' && !router.hasRoute('createSchedule')) {
            ...
            router.addRoute('mainLayout', scheduleCrewRoute)
            updateNavRoutes()
        }

        if (userRole === 'user' && !router.hasRoute('submitAvailability')) {
